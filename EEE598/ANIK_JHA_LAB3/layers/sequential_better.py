...
class Sequential_better(object):
    ...
    def forward(self, x, target=None):
        ...
        relu2 = self.layers[3].forward(y2)
        y3 = self.layers[4].forward(relu2)
        soft = self.layers[5].forward(y3)
    ...
    def backward(self):
        ...
        soft_b = self.layers[5].backward(loss_b)
        y3_b = self.layers[4].backward(soft_b)
        relu2_b = self.layers[3].backward(y3_b)
        y2_b = self.layers[2].backward(relu2_b)
